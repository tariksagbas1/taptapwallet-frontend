...
import { Shield, Store, MailPlus, LogOut, Loader2 } from "lucide-react";

const items = [
  { title: "İşletmeler", url: "/admin/merchants", icon: Store, end: true },
  { title: "Yeni İşletme", url: "/admin/merchants/new", icon: MailPlus },
  { title: "Davetler", url: "/admin/invites", icon: MailPlus },
];
